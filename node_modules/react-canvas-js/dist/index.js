...
var Canvas = function (_Component) {
    ...
    function Canvas() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Canvas.__proto__ || Object.getPrototypeOf(Canvas)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            debug: null
        }, _this.debugInterval = null, _this.canvasSizing = function (canvas) {
            window.can = canvas;
            ...
            if (_this.particles !== null && _typeof(_this.particles) === 'object') {
                _this.particles.stop();
                delete _this.particles;
            }

            _this.animate();
        }, _this.animate = function () {
            var options = _this.props.options;
            _this.particles = new Particles(_this.canvas, options);
            _this.particles.animate();
